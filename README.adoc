...
NEXT_PUBLIC_CHATBOT_NAME=John
NEXT_PUBLIC_CHATBOT_DESCRIPTION="The Computer Science Teaching Assistant"
NEXT_PUBLIC_CHATBOT_GREETING="Hello, I'm **John**, your Computer Science Teaching Assistant. How can I help you today?"
